...
query_for_user_uploaded_tests = "SELECT ltr.long_common_nm, ltr.loinc_system, ltr.investigation_department, ltr.time_aspect, ltr.is_panel, ltr.order_obs FROM lab.lab_org_test_xref lotx inner join lab.lab_test_ref  ltr on lotx.test_id=ltr.test_id"
...
def check_for_matches_exist(test_name_in_filtered_data, uploaded_test_index):
    ...
    elif fuzz.ratio(df_for_uploaded_tests_pre_process.at[uploaded_test_index, 'long_common_nm'], test_name_in_filtered_data) >= 100:
