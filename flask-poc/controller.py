...
@app.route('/fetchOrgGrpWiseInvoiceCount', methods=['POST'])
...
@app.route('/fetchOrgWiseInvoiceCount', methods=['POST'])
...
@app.route('/fetchOrgGrpWiseIpdCollections', methods=['POST'])
...
@app.route('/fetchOrgWiseIpdCollections', methods=['POST'])
...
@app.route('/fetchOrgGrpWiseOPDCollection', methods=['POST'])
...
@app.route('/fetchOrgWiseOPDCollections', methods=['POST'])
...
@app.route('/fetchOrgGrpWiseIpdAndOpdAndPharmacyCollections', methods=['POST'])
...
@app.route('/fetchOrgModuleWiseIpdAndOpdAndPharmacyCollections', methods=['POST'])
...
@app.route('/fetchBranchWiseCollections', methods=['POST'])
...
@app.route('/fetchBranchCollections', methods=['POST'])
...
@app.route('/totalRevenueGeneratedForIPDBeds', methods=['POST'])
...
@app.route('/fetchOrgWisePharmacyProfits', methods=['POST'])
